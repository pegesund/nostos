...
| 418   | 74 (cross-module generic Box/Pair/Either/Container types with HOF, trait impls on generic types with 3-way module split, trait impls defined before type definition alphabetically, diamond/triangle dependency patterns, 4-5 module deep chains, cross-module closures capturing imported values, re-exporting constructors transitively, complex record field access across modules, exception propagation across modules, cross-module sort/foldl/flatMap, function composition/currying across modules, BST insert/inorder with foldl, 5-module tokenizer pipeline, polymorphic wrap/unwrap at multiple types, recursive Tree mapTree/toList, mutual recursion myEven/myOdd, complex string processing, nested lambdas, chained method calls, pipe operators, nested match, recursive MyList reverse, church-like patterns) | All clean. 74/74 pass. No bugs found. | N/A | ~13,809 |
