...
| 46      | ~55 (3833-3887, 30 multi-file + 25 single-file) | (none - clean run, heavy focus on cross-module polymorphism, diamond deps, 4-module chains, generic types, record types, higher-order functions, closures returning closures, fold with Map) | N/A | ~3887 |
